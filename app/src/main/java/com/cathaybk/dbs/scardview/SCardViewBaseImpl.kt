...
open class SCardViewBaseImpl : SCardViewImpl {
    ...
    override fun initialize(
        cardView: SCardViewDelegate, context: Context,
        ...
        val background = createBackground(
            cardView, context, backgroundColor, radius,
    ...
    private fun createBackground(
        cardViewDelegate: SCardViewDelegate, context: Context,
        backgroundColor: ColorStateList, radius: Float, elevation: Float,
        maxElevation: Float, direction: Int, cornerVisibility: Int, startColor: Int,
        endColor: Int
    ): SRoundRectDrawableWithShadow {
        return SRoundRectDrawableWithShadow(
            cardViewDelegate, context.resources, backgroundColor, radius,
            elevation, maxElevation, direction, cornerVisibility, startColor, endColor
        )
    }
